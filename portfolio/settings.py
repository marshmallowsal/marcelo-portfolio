...
MIDDLEWARE = [
    ...
    # 'django.middleware.csrf.CsrfViewMiddleware',  # Temporarily disabled for Railway deployment
...
# Commented out because they can interfere with Railway's healthcheck
# if not DEBUG:
